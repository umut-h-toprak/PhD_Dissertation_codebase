...
public:
	...
	void padMateSupportHomologyRescue() {
		expectedDiscordants = mateSupport;
	}
	...
	void incrementDistinctReads() {
		++distinctReads;
	}
	void incrementMateSupport(int incrementIn) {
		mateSupport += incrementIn;
	}
	...
	int getDistinctReads() const {
		return distinctReads;
	}

	int getMatchFuzziness() const {
		return matchFuzziness;
	}
	...
	bool isLowMapqSource() const {
		return lowMapqSource;
	}
	...
	bool isNullMapqSource() const {
		return nullMapqSource;
	}
