...
def generateComparisonFrames():
    ...
    for pair in product(range(4), range(4)):
        ...
        _comparisonFrames[comparisonName] = [sum([["svTadOffset" + str(x) for x in range(xMax+1)] +
    ...
    for xMax in range(4):
        ...
        _comparisonFrames[svComparisonName ] = [["svTadOffset" + str(x) for x in range(xMax+1)], []]
        ...
        _comparisonFrames[offIndelComparisonName] = [["indelTadOffset" + str(x) for x in range(xMax+1)], []]
    ...
    _comparisonFrames["DirectSv"] = [["directSV"], []]
    _comparisonFrames["FunctionalSmallVar.DirectSv"] = [functionalSmallVarTypes + ["directSV"], []]
